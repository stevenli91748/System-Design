...
* [4种NoSQL 方案](#4种NoSQL 方案)
  ...
  * [文档数据库---解决关系数据库强schema 约束的问题，以MongoDB 为代表](#文档数据库解决关系数据库强schema 约束的问题)
  * [列式数据库： 解决关系数据库大数据场景下的I/O 问题，以HBase 为代表](#列式数据库解决关系数据库大数据场景下的I/O 问题)
...
## 文档数据库解决关系数据库强schema 约束的问题
   

## 列式数据库解决关系数据库大数据场景下的I/O 问题
