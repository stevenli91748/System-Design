...
[系统分析与设计实验项目---多个项目](https://sysu-swsad.github.io/swad-guide/00-project-intro)|[系统设计面试题精选](https://soulmachine.gitbooks.io/system-design/content/cn/)|[凤凰架构---构建可靠的大型分布式系统](https://icyfenix.cn/)|
----|---|---|
