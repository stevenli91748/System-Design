...
# 系统设计视频
* [System Design Interview: A Step-By-Step Guide](https://www.youtube.com/@ByteByteGo/videos)
...
[IT老齐架构600讲](https://www.bilibili.com/video/BV1WM4y1N79G/?spm_id_from=333.788&vd_source=be3ac4894f8bf7883ae92030f6f7be46)|
---|
...
[MikeChen的互联网架构](https://mikechen.cc/)|
---|
   ...
   * 数据库架构设计
     ...
     * 数据拆分
       ...
       * [数据库中间件详解（精品长文）---数据库拆分过程基本遵循的顺序是：垂直拆分、读写分离、分库分表(水平拆分)](https://zhuanlan.zhihu.com/p/87144535)
         * 分库分表的优缺点和为什么
          * jdbc应用层分片 ： sharedingsphere, tddl，实现分库分表的程序是内嵌在jar包中，所以性能是比使用proxy代理层分片好
